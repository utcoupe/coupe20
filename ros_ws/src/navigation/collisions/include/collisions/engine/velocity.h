...
public:
    ...
    Velocity(double width, double height, double velLinear = 0.0, double velAngular = 0.0) noexcept:
    ...
    void setVelLinear(double velLinear) noexcept
    { velLinear_ = velLinear; }
    void setVelAngular(double velAngular) noexcept { velAngular_ = velAngular; }

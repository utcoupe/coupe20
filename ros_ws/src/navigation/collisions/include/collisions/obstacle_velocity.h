...
public:
     ...
     * 
     * For now, only rectangle shape works, and it must be describe with its width and its height.
     * 
     ...
     */
    ObstacleVelocity(double width, double height, double velLinear = 0.0, double velAngular = 0.0,
     ...
     * 
     * A maximum expansion distance can be passed by parameter. It is disbled when the value is EXPANSION_DIST_DISABLED.
     * This function uses internal cache updated only when needed.
     * 

...
#include <inttypes.h>
    ...
    #define MOTOR12_39KHZ  0 
    #define MOTOR12_19KHZ  0 
    #define MOTOR12_8KHZ   0 
    #define MOTOR12_4_8KHZ 0 
    #define MOTOR12_2KHZ   0 
    #define MOTOR12_1KHZ   0 

    #define MOTOR34_64KHZ  0 
    #define MOTOR34_39KHZ  0 
    #define MOTOR34_19KHZ  0 
    #define MOTOR34_8KHZ   0 
    #define MOTOR34_4_8KHZ 0 
    #define MOTOR34_2KHZ   0 
    #define MOTOR34_1KHZ   0 
